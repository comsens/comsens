...
<head>
<link rel="shortcut icon" href="<?php echo G5_URL?>/fa.ico" />
<meta charset="utf-8">
<?php
if (G5_IS_MOBILE) {
...
<link rel="stylesheet" href="<?php echo G5_THEME_CSS_URL ?>/bootstrap.min.css" type="text/css" rel="stylesheet">

<!--그누스트랩-->
<script src="<?php echo G5_THEME_JS_URL ?>/gnustrap.js"></script>
