...
<div class="panel panel-default">
  <div class="panel-body">
        <?php if ($is_admin == "super") {  ?><a href="<?php echo G5_ADMIN_URL ?>/poll_form.php?w=u&amp;po_id=<?php echo $po_id ?>" style="float: right;"><i class="fa fa-cog tooltip-top" title="" data-original-title="설정"></i></a><?php }  ?>
	  ...
	  <div class="text-center">
        <input type="submit" value="투표하기" class="btn btn-default">
        <a href="<?php echo G5_BBS_URL."/poll_result.php?po_id=$po_id&amp;skin_dir=".urlencode($skin_dir); ?>" target="_blank" class="btn btn-default" onclick="poll_result(this.href); return false;">결과보기</a>
	  </div>
  </div>
