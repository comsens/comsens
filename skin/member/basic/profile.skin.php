...
<div class="modal-dialog">
    ...
    <div class="modal-body">
							  ...
							  <i class="fa fa-calendar tooltip-top fa-fw" title="회원 가입일" ></i> <?php echo ($member['mb_level'] >= $mb['mb_level']) ?  substr($mb['mb_datetime'],0,10) ." (".number_format($mb_reg_after)." 일)" : "알 수 없음";  ?>
							  </p>
								   <?php if ($mb_homepage) {  ?>
