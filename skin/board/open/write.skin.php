...
<section id="bo_w">
	...
	<input type="hidden" name="wr_subject"  value="<?php echo $site;?> 오픈 요청">
    <?php
    $option = '';
    $option_hidden = '';
...
<div class="panel panel-default">
    ...
    <div class="panel-body">
                  ...
                  <select name="ca_name" id="ca_name" required class="form-control required pc-input">
                    ...
                    <?php 
						...
						if($is_admin){
							...
							echo '<option value="오픈요청" selected>오픈요청</option>';			
						}
		 ...
		 */?>
 <?php
			$write['wr_link1']=$_SERVER['HTTP_REFERER'];
			$write['wr_link2']=$site;
			?>


<div class="form-group input-group  col-md-12 pull-left">
  <span class="input-group-addon tooltip-top" title="" for="wr_link2" data-original-title="링크 2번째"><i class="fa fa-link fa-fw"></i> 오픈 요청 주소<strong class="sr-only">링크</strong></span>
  <input type="text" name="wr_link2" value="<?php if($w=="u"){echo $write['wr_link2'];}else{ echo $write['wr_link2'];} ?>" id="wr_link2" id="wr_link2" class="form-control" placeholder="오픈URL주소" maxlength="255" >
</div>
<div class="form-group input-group  col-md-12 pull-left">
  <span class="input-group-addon tooltip-top" title="" for="wr_link1" data-original-title="링크 1번째"><i class="fa fa-link fa-fw"></i># REFFERE 주소<strong class="sr-only">링크</strong></span>
  <input type="text" name="wr_link1" value="<?php if($w=="u"){echo $write['wr_link1'];}else{ echo $write['wr_link1'];} ?>" id="wr_link1" class="form-control" placeholder="REFERER 주소" maxlength="255" >
</div>
        ...
        <div class="row">
				...
				<p id="char_count_desc"><strong>(필수)</strong> 업무에 필요한 사유를 간단히 적어주세요!!</p>
		...
		<?php //include_once(G5_TAG_PATH."/view.tag.write.skin.php");?>
			...
			for ($i=1; $is_link && $i<=G5_LINK_COUNT; $i++) { ?>
			   <div class="form-group input-group  col-md-6 pull-left">
                  ...
                  <input type="text" name="wr_link<?php echo $i ?>" value="<?php if($w=="u"){echo $write['wr_link'.$i];}else{ echo $write['wr_link'.$i];} ?>" id="wr_link<?php echo $i ?>" class="form-control"placeholder="링크주소" maxlength="255" >
				</div>
            <?php } 
