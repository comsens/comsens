...
<div id="bo_list" style="width:<?php echo $width; ?>" class="panel-body table-content">
	...
	<div class="clearfix" style="height:45px;">
		...
		<div class="pull-right">
			...
			<ul class="dropdown-menu pull-right" role="menu">
                ...
                <?php if ($write_href) { ?><li><a href="<?php echo $write_href ?>"><i class="fa fa-edit"></i> 사이트 오픈 요청</a></li><?php } ?>
    ...
    <?php if ($list_href || $is_checkbox || $write_href) { ?>
        ...
        <?php if ($is_admin) { ?><a href="<?php echo $write_href ?>" class="btn btn-default btn-sm"><i class="fa fa-edit"></i> 글쓰기</a><?php } ?>
		<?php if ($write_href) { ?><a href="<?php echo G5_BBS_URL ?>/write.php?bo_table=open" class="btn btn-default btn-sm"><i class="fa fa-edit"></i> 사이트 오픈 요청</a><?php } ?>
        </div>
        <?php } ?>
