...
<link rel="stylesheet" href="<?php echo G5_ADMIN_URL ?>/css/bootstrap.min.css">
</head>
...
<div class="alert alert-warning"><strong>그누스트랩5</strong>를 먼저 설치해주십시오.</div>

<ul class="list-group">
  <li class="list-group-item">다음 파일을 찾을 수 없습니다.</li>
  <li class="list-group-item"><strong><?php echo G5_DATA_DIR.'/'.G5_DBCONFIG_FILE ?></strong></li>
  <li class="list-group-item">그누스트랩5 설치 후 다시 실행하시기 바랍니다.</li>
</ul>

    <div class="text-center">
        <a href="<?php echo G5_URL; ?>/install/" class="btn btn-default" style="margin-bottom:15px;"><?php echo G5_VERSION ?> 설치하기</a>
    </div>

<div class="well well-sm">
    <strong>GNUSTRAP5</strong><span class="pull-right">GPL! OPEN SOURCE GNUBOARD & BOOTSTRAP</span>
</div>
</div>
